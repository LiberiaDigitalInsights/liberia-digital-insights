      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <div className="animate-pulse">
            ...
            <div className="h-3 bg-gray-200/20 rounded w-1/2 mb-1"></div>
            <div className="h-3 bg-gray-200/20 rounded w-1/3"></div>
          </div>
      ...
      <CardContent className="space-y-3">
        {latestPodcast ? (
          <div className="space-y-1">
            ...
            <div className="text-xs text-muted">
              {new Date(latestPodcast.published_at).toLocaleDateString(
                "en-US",
                {
                  month: "short",
                  day: "numeric",
            ...
            <div className="text-xs text-muted">{latestPodcast.duration}</div>
          </div>
        ) : (
        ...
        <Button
          ...
          onClick={() =>
            ...
            window.open(latestPodcast.audio_url, "_blank")
          }
