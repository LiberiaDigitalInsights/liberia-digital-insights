    ...
    <div className="mx-auto max-w-7xl px-4 py-8 md:px-6 md:py-12">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <Card className="p-6">
            ...
            <p className="text-sm text-[var(--color-muted)]">
              Stay updated with the latest technology news, trends, and developments in Liberia and
              across Africa.
            </p>
          </Card>
          <Card className="p-6">
      ...
      <Card className="bg-brand-500/5 p-8 text-center">
        ...
        <Muted className="mb-6 mx-auto max-w-2xl">
          Be part of Liberia's digital transformation story. Subscribe to our newsletter, follow us
          on social media, or get in touch to learn more about how we can collaborate.
        </Muted>
