      ...
      <div className="mx-auto max-w-7xl px-4 py-8 md:px-6 md:py-12">
        ...
        <header className="mb-12 text-center">
          ...
          <Muted className="mx-auto max-w-3xl text-lg">
            Have a question, suggestion, or want to collaborate? We'd love to hear from you. Fill
            out the form below or reach us directly through our contact information.
          </Muted>
        </header>
