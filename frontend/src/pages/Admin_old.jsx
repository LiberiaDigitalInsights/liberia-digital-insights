...
export default function Admin() {
  ...
  const filteredTalents = talents.filter(
    (x) =>
      (tStatus === 'all' || x.status === tStatus) &&
      (!tQuery || x.name.toLowerCase().includes(tQuery.toLowerCase())),
  );
  const tSorted = React.useMemo(() => {
    ...
    if (tSort === 'name_asc') arr.sort(nameCmp);
      ...
      arr.sort((a, b) =>
        a.status === b.status ? 0 : a.status === 'pending' || a.status === 'draft' ? -1 : 1,
      );
    return arr;
                              ...
                              <Button
                                ...
                                onClick={() =>
                                  askConfirm(() => {
                                    if (!canEdit) return;
                                    const next =
                                      row.status === 'published' ? 'pending' : 'published';
        ...
        {reviewItem && (
          <div className="space-y-2">
            ...
            <div>
              ...
              <div className="inline-block rounded-full border px-2 py-0.5 text-xs">
                {reviewItem.status}
              </div>
            </div>
          </div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-[var(--color-text)]">1,247</p>
                </div>
            ...
            <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-[var(--color-muted)]">Active Today</p>
            ...
            <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-[var(--color-muted)]">New This Week</p>
            ...
            <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-[var(--color-muted)]">Premium Users</p>
            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-[var(--color-border)]">
                <tr>
                  <td className="px-4 py-3">
                    <div className="flex items-center">
                      <div className="h-8 w-8 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white text-sm font-medium mr-3">
                        JD
                      </div>
                      <div>
                        <p className="text-sm font-medium text-[var(--color-text)]">John Doe</p>
                        <p className="text-xs text-[var(--color-muted)]">john@example.com</p>
                      </div>
                    </div>
                  </td>
                  <td className="px-4 py-3">
                  ...
                  <td className="px-4 py-3 text-sm text-[var(--color-muted)]">2 hours ago</td>
                  <td className="px-4 py-3">
                    <div className="flex gap-2">
                ...
                <tr>
                  <td className="px-4 py-3">
                    <div className="flex items-center">
                      <div className="h-8 w-8 rounded-full bg-gradient-to-br from-green-500 to-teal-600 flex items-center justify-center text-white text-sm font-medium mr-3">
                        SM
                      </div>
                      <div>
                        ...
                        <p className="text-xs text-[var(--color-muted)]">sarah@example.com</p>
                      </div>
                    </div>
                  </td>
                  <td className="px-4 py-3">
                  ...
                  <td className="px-4 py-3 text-sm text-[var(--color-muted)]">1 day ago</td>
                  <td className="px-4 py-3">
                    <div className="flex gap-2">
                      <Button variant="ghost" size="sm">
                        <FaEdit className="h-3 w-3" />
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Textarea
                    defaultValue="Your gateway to Liberia's digital transformation"
                    rows={3}
                  />
                </div>
                <div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-[var(--color-muted)]">Page Views</p>
                  <p className="text-2xl font-bold text-[var(--color-text)]">45.2K</p>
            ...
            <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-[var(--color-muted)]">Unique Visitors</p>
                  <p className="text-2xl font-bold text-[var(--color-text)]">12.8K</p>
            ...
            <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-[var(--color-muted)]">Avg. Session</p>
                  <p className="text-2xl font-bold text-[var(--color-text)]">3:42</p>
            ...
            <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-[var(--color-muted)]">Bounce Rate</p>
                  <p className="text-2xl font-bold text-[var(--color-text)]">32.4%</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg p-4">
              <h3 className="text-lg font-medium text-[var(--color-text)] mb-4">Traffic Sources</h3>
            ...
            <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg p-4">
              <h3 className="text-lg font-medium text-[var(--color-text)] mb-4">Popular Pages</h3>
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-[var(--color-text)]">/insights</span>
                  <span className="text-sm text-[var(--color-muted)]">8,432 views</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-[var(--color-text)]">/talent</span>
                  <span className="text-sm text-[var(--color-muted)]">6,221 views</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-[var(--color-text)]">/podcasts</span>
                  <span className="text-sm text-[var(--color-muted)]">5,892 views</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-[var(--color-text)]">/events</span>
                  <span className="text-sm text-[var(--color-muted)]">4,156 views</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-[var(--color-text)]">/training-courses</span>
                  <span className="text-sm text-[var(--color-muted)]">3,789 views</span>
                </div>
              </div>
            </div>
          </div>
