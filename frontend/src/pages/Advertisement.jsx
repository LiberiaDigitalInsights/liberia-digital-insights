        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div>
            ...
            <p className="text-sm text-[var(--color-muted)]">
              Connect with Liberia's technology leaders, entrepreneurs, and innovators who actively
          ...
          <div>
            ...
            <p className="text-sm text-[var(--color-muted)]">
              Reach your audience through our website, newsletter, podcasts, and events for maximum
              visibility.
            </p>
          </div>
          <div>
            ...
            <p className="text-sm text-[var(--color-muted)]">
              Choose from standard packages or work with us to create a custom advertising solution
