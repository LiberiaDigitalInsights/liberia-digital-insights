...
import { FaEye, FaUsers, FaNewspaper, FaMicrophone, FaCalendar } from 'react-icons/fa';
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button className="p-4 border border-[var(--color-border)] rounded-lg hover:bg-[var(--color-surface)] transition-colors">
              <FaNewspaper className="w-6 h-6 text-brand-500 mb-2" />
              <p className="text-sm font-medium text-[var(--color-text)]">Create Article</p>
            </button>
            <button className="p-4 border border-[var(--color-border)] rounded-lg hover:bg-[var(--color-surface)] transition-colors">
              <FaMicrophone className="w-6 h-6 text-brand-500 mb-2" />
              <p className="text-sm font-medium text-[var(--color-text)]">Upload Podcast</p>
            </button>
            <button className="p-4 border border-[var(--color-border)] rounded-lg hover:bg-[var(--color-surface)] transition-colors">
              <FaCalendar className="w-6 h-6 text-brand-500 mb-2" />
              <p className="text-sm font-medium text-[var(--color-text)]">Create Event</p>
            </button>
          </div>
        </CardContent>
      </Card>
