...
const AdminInsights = ({ insights, canEdit }) => {
  ...
  const handleCreate = () => {
    ...
    const newInsight = {
      ...
      author: formData.author || 'Current User',
      tags: formData.tags
        .split(',')
        .map((tag) => tag.trim())
        .filter((tag) => tag),
    ...
    setInsightsList([newInsight, ...insightsList]);
  ...
  const handleEdit = (insight) => {
    ...
    setFormData({
      ...
      coverImage: insight.coverImage || insight.image || '',
    });
  ...
  const handleUpdate = () => {
    ...
    const updatedInsights = insightsList.map((insight) =>
      insight.id === selectedInsight.id
        ? {
            ...
            tags: formData.tags
              ...
              .filter((tag) => tag),
            coverImage: formData.coverImage,
            image: formData.coverImage || insight.image,
          }
        : insight,
    );
  ...
  const confirmDelete = () => {
    ...
    setInsightsList(insightsList.filter((insight) => insight.id !== selectedInsight.id));
      ...
      >
        <div className="space-y-4">
          ...
          <div className="flex gap-2 justify-end">
            ...
            <Button onClick={handleCreate}>Create Insight</Button>
          </div>
        </div>
      </Modal>
      ...
      <Modal open={showEditModal} onClose={() => setShowEditModal(false)} title="Edit Insight">
        <div className="space-y-4">
          ...
          <div className="flex gap-2 justify-end">
            ...
            <Button onClick={handleUpdate}>Update Insight</Button>
          </div>
        </div>
      </Modal>
