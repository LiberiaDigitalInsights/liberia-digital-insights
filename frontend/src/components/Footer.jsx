...
const Footer = () => {
  return (
    <footer
      className="relative mt-16 overflow-hidden bg-[linear-gradient(135deg,var(--color-surface)_0%,color-mix(in_oklab,var(--color-surface),black_8%)_50%,color-mix(in_oklab,var(--color-surface),black_12%)_100%)] border-t border-[var(--color-border)]"
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 py-16 md:py-20">
        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-[1.2fr_1fr_1.2fr] lg:gap-20">
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-4">
              <div className="rounded-2xl bg-gradient-to-br from-brand-500/10 to-brand-600/5 p-3">
                <Logo />
              </div>
            </div>
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-[var(--color-text)] font-medium">Advertise:</span>
                  <a
                    href="mailto:sales@liberiadigitalinsights.com"
                    className="text-sm text-[var(--color-muted)] transition-all duration-200 hover:text-brand-500 hover:underline"
                  >
                ...
                <div className="flex items-center gap-3">
                  <div className="flex h-2 w-2 rounded-full bg-brand-500" />
                  <span className="text-sm text-[var(--color-text)] font-medium">Newsroom:</span>
                  <a
            ...
            <div className="pt-4">
              <h4 className="mb-4 text-xs font-semibold uppercase tracking-wider text-[var(--color-muted)]">
                Connect With Us
              </h4>
              <div className="flex flex-wrap gap-3">
                <a
                  ...
                  className="group inline-flex h-10 w-10 items-center justify-center rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] text-[var(--color-muted)] transition-all duration-200 hover:border-brand-500 hover:bg-brand-500 hover:text-white hover:shadow-lg hover:shadow-brand-500/25 focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-surface)] focus:outline-none"
                >
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-brand-500/10 to-brand-600/10 px-4 py-2 border border-brand-500/20">
        ...
        {/* Bottom bar */}
        <div className="mt-20 flex flex-col items-center justify-between gap-6 border-t border-[var(--color-border)] pt-8 md:flex-row">
          ...
          <div className="flex items-center gap-6 text-xs">
            <Link
              to="/privacy"
              className="text-[var(--color-muted)] transition-colors hover:text-[var(--color-text)] hover:underline"
            >
              Privacy Policy
            </Link>
            <Link
