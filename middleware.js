...
export function middleware(request) {
  ...
  if (process.env.NODE_ENV === "production") {
    const cspValues = [
      ...
      "img-src 'self' blob: data: https: https://*.fbcdn.net https://*.fbcdn.com https://*.fbsbx.com https://images.unsplash.com https://*.unsplash.com https://vercel.com",
      "font-src 'self' data: https://vercel.live https://*.vercel.live https://fonts.gstatic.com https://fonts.googleapis.com",
      "connect-src 'self' https: https://*.supabase.co https://*.vercel.com https://*.vercel-insights.com https://*.vercel-storage.com https://vercel.live https://*.vercel.live ws: wss:",
      "media-src 'self' https: https://*.supabase.co",
      "frame-src 'self' https://vercel.live https://*.vercel.live https://vercel.com https://*.vercel.app",
